...
public interface DownloadedFileUtil {
   ...
   *
   * @param seleniumWebDriver ID of web driver session which holds downloaded package
   ...
   *
   * @param seleniumWebDriver ID of web driver session which holds downloaded file
